...
/*/Initialising an empty array or retrieving from local storage

let tasks = JSON.parse(localStorage.getItem(`tasks`)) || [];
//select
const managerContainer = document.querySelector(".taskManager");
const clssConfirm = document.querySelector(".confirm");
...
document.getElementById(`taskForm`).addEventListener(`submit`, handleFromSubmit);
...
const btnContEl = document.createElement("span");
togBtn.classList.add("button-box");
btnContEl.classList.add("green");
btnContEl.innerText = task.completed ? `mark pendinding` : `mark completed`;
togBtn.appendChild(btnContEl);
...
delBtnContentEl.classList.add("red");
    ...
    deleteButton.addEventListener('click', () => {
      ...
      managerContainer.classList.add("overlay");
    });
...
const confirmedBtn = confirmEl.querySelector(".remove");
